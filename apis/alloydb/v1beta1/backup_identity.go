...
var parser = regexp.MustCompile(`^((//)?alloydb.googleapis.com)?/?projects/(?P<projects>` + util.ProjectIDRegexp + `)/locations/(?P<locations>[a-zA-Z0-9_-]+)/backups/(?P<backups>[a-zA-Z0-9_-]+)$`)
