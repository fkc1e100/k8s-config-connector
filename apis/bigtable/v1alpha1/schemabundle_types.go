...
type BigtableSchemaBundleParent struct {
	// +required
	TableRef *v1beta1.TableRef `json:"tableRef,omitempty"`
}
...
// BigtableSchemaBundleSpec defines a state of BigtableSchemaBundle
// +kcc:proto=google.bigtable.admin.v2.SchemaBundle
type BigtableSchemaBundleSpec struct {
	// The BigtableSchemaBundle ID. If not given, the metadata.name will be used.
